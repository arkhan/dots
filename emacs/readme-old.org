...
(use-package org
  ...
  (progn
    ...
    (add-hook 'org-mode-hook #'conf:org-mode-hook)))
...
(use-package counsel-tramp
  ...
  :hook ((counsel-tramp-pre-command . (lambda () (projectile-mode 0)
                                        (editorconfig-mode 0)))
         (counsel-tramp-quit . (lambda () (projectile-mode 1)
                                 (editorconfig-mode 1)))))
#+end_src
...
(set-face-attribute 'default nil :font "Operator Mono:pixelsize=15")
#+end_src
...
(use-package lsp-ui
  ...
  (add-hook 'lsp-mode-mode #'lsp-ui-mode))
...
(use-package rg
  :config (setq rg-command-line-flags (list "-uuu" "-S" "-g" "'!/volumes'" "-g" "'!/backups'" "-g" "'!/.git'" "--no-heading" "--line-number" "--color" "never")))
#+end_src
*** rainbow
#+begin_src emacs-lisp
...
(use-package org-sync-snippets
  ...
  :config (setq org-sync-snippets-org-snippets-file "~/.emacs.d/snippets/snippets.org"))
#+end_src
** Langs
*** docker
#+begin_src emacs-lisp
...
:hook (ediff-prepare-buffer . ediff-outline-show-all))
#+end_src
** editorconfig
#+begin_src emacs-lisp
...
(use-package diff-hl
  ...
  ;; (set-face-background 'diff-hl-margin-insert "black")
  ;; (set-face-background 'diff-hl-margin-delete "black")
  ;; (set-face-background 'diff-hl-margin-change "black")
  ;; (set-face-background 'diff-hl-margin-ignored "black")
  ;; (set-face-background 'diff-hl-margin-unknown "black")
...
#+begin_src emacs-lisp
(use-package logview
  :hook (logview-mode . auto-revert-mode))
#+end_src
