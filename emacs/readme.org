...
#+BEGIN_SRC emacs-lisp
  (use-package flyspell
    ...
    (setq-default ispell-program-name "aspell"
                  ...
                  ispell-extra-args '("-a" "--sug-mode=ultra")
...
#+BEGIN_SRC emacs-lisp :tangle no
  (use-package pyenv-mode
    :ensure t
    :config
    (defun conf:pyenv-mode-set (version)
      ...
      (setenv "VIRTUAL_ENV" (pyenv-mode-full-path version))
      (force-mode-line-update))

    (advice-add 'pyenv-mode-set :override #'conf:pyenv-mode-set)

    (defun conf:pyenv-mode-unset ()
    ...
    (advice-add 'pyenv-mode-unset :override #'conf:pyenv-mode-unset)
...
#+BEGIN_SRC emacs-lisp :tangle no
  ...
  (use-package font-lock+
    :ensure (font-lock+ :type git :host github :repo "emacsmirror/font-lock-plus"))

  (use-package sidebar
    :ensure (sidebar.el :type git :host github :repo "samangh/sidebar.el")
...
** Tipografía
#+BEGIN_SRC emacs-lisp
  (set-face-attribute 'default nil :family "FantasqueSansMono NF" :height 100)
