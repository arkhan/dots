...
** Directorio Temporal
#+BEGIN_SRC emacs-lisp
  (defvar conf:local-dir (concat user-emacs-directory "local/"))
  (unless (file-exists-p conf:local-dir)
    (make-directory conf:local-dir))
  (defvar conf:cache-dir (concat conf:local-dir "cache/"))
  (unless (file-exists-p conf:cache-dir)
    (make-directory conf:cache-dir))
  (defvar conf:pkg-dir (concat conf:local-dir "pkg/"))
  (unless (file-exists-p conf:pkg-dir)
    (make-directory conf:pkg-dir))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq package-user-dir (concat conf:pkg-dir "elpa")
...
#+BEGIN_SRC emacs-lisp
  (use-package recentf
    ...
    (add-to-list 'recentf-exclude conf:cache-dir)
    (add-to-list 'recentf-exclude conf:pkg-dir)
    (recentf-mode +1))
#+END_SRC
*** Saveplace
#+BEGIN_SRC emacs-lisp
