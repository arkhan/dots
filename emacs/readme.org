...
#+BEGIN_SRC emacs-lisp
  ...
  (set-face-attribute 'default nil :family "MonacoB" :height 110)
            ...
            (save-excursion
              (let*
                  ((from (save-restriction
                   ...
                   (account
                    (cond
                     ((string-match "edison@disroot.org" from) "Personal")
                     ((string-match "arkhan@disroot.org" from) "Work"))))
...
#+BEGIN_SRC emacs-lisp
  (use-package python
    ...
    (setq python-shell-interpreter "python"
          lsp-pyls-configuration-sources ["python-flake8"]
...
;;    :config (add-hook 'projectile-after-switch-project-hook 'pyenv-mode-auto-hook)
#+END_SRC
** PEP8
#+BEGIN_SRC emacs-lisp
  (use-package blacken
