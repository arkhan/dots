  ...
  (defun tangle-init-async ()
    ...
    (when (or
      ...
      (let ((prog-mode-hook nil))
        (async-shell-command "sh -c \"/usr/bin/emacs ~/.emacs.d/readme.org --batch --eval='(org-babel-tangle)' && /usr/bin/emacs -l ~/.emacs.d/init.el --batch --eval='(byte-recompile-directory user-emacs-directory)'\""))))
